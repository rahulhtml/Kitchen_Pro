...
const SearchCard = () => {
    ...
    const recipe_app_id = "be132e63";
    const recipe_app_key = "9c1cbb9696bffc63e8daed3a33dfa775";
    const food_app_id = "cc593ff2";
    const food_app_key = "19884a60e022671582d5bdb4198ecb37";
